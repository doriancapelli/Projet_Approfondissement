...
class __TwigTemplate_06c7f52bd892d2a97e68fd718aa0a835898bec4617c2f664705a58f07812e098 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["has_slave_configure"] ?? null)) {
            ...
            // line 107
            echo "    ";
            $___internal_4356ce160964fbd531f392b1a7feb6dc282d22192a83b741a454b01ecadfd339_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 102
            echo sprintf($___internal_4356ce160964fbd531f392b1a7feb6dc282d22192a83b741a454b01ecadfd339_, (("<a href=\"server_replication.php\" data-post=\"" . PhpMyAdmin\Url::getCommon(twig_array_merge(($context["url_params"] ?? null), ["sl_configure" => true, "repl_clear_scr" => true]))) . "\">"), "</a>");
            // line 108
            echo "  ";
        }
        // line 109
...
";
    ...
    {
        return new Source("", "server/replication/slave_configuration.twig", "F:\\WWW\\UwAmp - PHP8\\phpapps\\phpmyadmin\\templates\\server\\replication\\slave_configuration.twig");
    }
}
