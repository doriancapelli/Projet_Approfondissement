        ...
        <div class="h-screen w-screen bg-gray-300 flex items-center">
	        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-900">
   		        <div class="max-w-md">
                    ...
                    <button class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-gray-900 active:bg-blue-600 hover:bg-gray-700"><a href="X-dorcapelli-login"> Retour à la page de login></button>
                </div>
            <div class="max-w-lg"> 
        </div>
    </body>
